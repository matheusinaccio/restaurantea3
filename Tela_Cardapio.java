...
public class Tela_Cardapio extends JFrame {    
	...
	public Tela_Cardapio() {
		...
		class TextAreaPrinter implements Printable {
	        private JTextArea textArea;
	        ...
	        public int print(Graphics g, PageFormat pf, int page) throws PrinterException {
	            ...
	            // Ajuste a escala para a resolução da impressora térmica
	            double scaleX = pf.getImageableWidth() / textArea.getWidth();
	            double scaleY = pf.getImageableHeight() / textArea.getHeight();
